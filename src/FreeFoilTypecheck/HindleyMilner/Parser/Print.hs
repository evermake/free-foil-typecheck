...
module FreeFoilTypecheck.HindleyMilner.Parser.Print where
...
instance Print FreeFoilTypecheck.HindleyMilner.Parser.Abs.Ident where
  prt _ (FreeFoilTypecheck.HindleyMilner.Parser.Abs.Ident i) = doc $ showString i
instance Print FreeFoilTypecheck.HindleyMilner.Parser.Abs.UVarIdent where
  prt _ (FreeFoilTypecheck.HindleyMilner.Parser.Abs.UVarIdent i) = doc $ showString i
instance Print FreeFoilTypecheck.HindleyMilner.Parser.Abs.Pattern where
  prt i = \case
    FreeFoilTypecheck.HindleyMilner.Parser.Abs.PatternVar id_ -> prPrec i 0 (concatD [prt 0 id_])
...
instance Print FreeFoilTypecheck.HindleyMilner.Parser.Abs.ScopedExp where
  prt i = \case
    FreeFoilTypecheck.HindleyMilner.Parser.Abs.ScopedExp exp -> prPrec i 0 (concatD [prt 1 exp])

instance Print FreeFoilTypecheck.HindleyMilner.Parser.Abs.TypePattern where
  prt i = \case
    FreeFoilTypecheck.HindleyMilner.Parser.Abs.TPatternVar id_ -> prPrec i 0 (concatD [prt 0 id_])

instance Print FreeFoilTypecheck.HindleyMilner.Parser.Abs.Type where
  prt i = \case
...
instance Print FreeFoilTypecheck.HindleyMilner.Parser.Abs.ScopedType where
  prt i = \case
    FreeFoilTypecheck.HindleyMilner.Parser.Abs.ScopedType type_ -> prPrec i 0 (concatD [prt 1 type_])
